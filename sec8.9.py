...
# -*- coding: utf-8 -*-
"""
Created on Sat May 30 10:16:41 2020
...
def PsudoRand(p,N,size,number_of_sample):
    psudo = np.random.poisson(p,N)#generate a thousand unidform random number from uniform distribution
